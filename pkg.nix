...
, fingertree, free, hashable, network, process, QuickCheck, random, semigroups
...
mkDerivation {
  ...
  libraryHaskellDepends = [
    ...
    hashable network process QuickCheck random semigroups stm tasty tasty-quickcheck
    text transformers void
  ];
  testHaskellDepends = [
    array base bytestring cborg clock containers fingertree free hashable
    network process QuickCheck random semigroups stm tasty tasty-quickcheck text
    transformers void
  ];
